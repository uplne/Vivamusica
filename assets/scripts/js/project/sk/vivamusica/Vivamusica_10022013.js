...
sk.vivamusica.Vivamusica = (function() {
	...
	function initialize(sLang) {
		...
		/*var obj = new sk.vivamusica.sections.Sienslavy();
		obj.initialize();*/
...
sk.vivamusica.utils.BoxController.BoxNormal = function() {
	...
	this.showBox = function() {
		self.box.css({
			...
			'opacity' : 0,
			'filter'  : 'alpha(opacity = 0)',
			'top'     : self.main.height() * .5 - self.box.height() * .5,
...
sk.vivamusica.controllers.Controller = function() {
	...
	function updateTitle() {
		var tit      = (sk.vivamusica.Vivamusica.getLanguage() == 'sk') ? titles : titlesen,
				...
				subtitle = ((newpage == 'team') || (newpage == 'program') || (newpage == 'media') || ((newpage == 'sienslavy') || (newpage == 'halloffame'))) ? '' : subpage;
...
sk.vivamusica.utils.DockMenu = function() {
	var proximity = 150,
			...
			function moveDock() {
				...
				console.log(mouseX, offset, $dockul.width(), dockWidth);
...
sk.vivamusica.sections.Galeria = function(subpage) {
	...
	function showSubmenu() {
		...
		if (sk.vivamusica.Vivamusica.getLanguage() == 'sk') {
			$('.subnav').append('<li><a class="renaultBold" href="#/galeria">2011</a></li><li><a class="renaultBold" href="#/galeria/2010">2010</a></li><li><a class="renaultBold" href="#/galeria/2009">2009</a></li><li><a class="renaultBold" href="#/galeria/2008">2008</a></li>');
		} else {
			$('.subnav').append('<li><a class="renaultBold" href="#/galeria">2011</a></li><li><a class="renaultBold" href="#/gallery/2010">2010</a></li><li><a class="renaultBold" href="#/gallery/2009">2009</a></li><li><a class="renaultBold" href="#/gallery/2008">2008</a></li>');
		}
