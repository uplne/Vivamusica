  ...
  var jqDock = function(){
    ...
    return {
      ...
      , defaults : { //can be set at runtime, per menu
          size : 145 //[px] maximum minor axis dimension of image (width or height depending on 'align' : vertical menu = width, horizontal = height)
        , distance : 100//[px] attenuation distance from cursor
        , coefficient : .6 //attenuation coefficient
